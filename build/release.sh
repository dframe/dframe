...
# Tag Components
for REMOTE in asset config console cron loader router session token view
do
    echo ""
    echo ""
    echo "Releasing $REMOTE";

    TMP_DIR="/home/kajtek/tmp/dframe-split"
    REMOTE_URL="git@github.com:dframe/$REMOTE.git"
